...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  if (($uD(delta.apply__O()) < 0)) {
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this) {
      return (function() {
    ...
    var x = $uD(delta.apply__O());
    var sqrtDelta = $uD($g.Math.sqrt(x));
    var doubleA = (2 * $uD(a.apply__O()));
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2$1, b$1, sqrtDelta$1, doubleA$1) {
      return (function() {
        var this$8 = $m_s_Predef$().Set$3;
        var array = [(((-$uD(b$1.apply__O())) + sqrtDelta$1) / doubleA$1), (((-$uD(b$1.apply__O())) - sqrtDelta$1) / doubleA$1)];
        var elems = new $c_sjsr_WrappedVarArgs().init___sjs_js_Array(array);
        return this$8.from__sc_IterableOnce__sci_Set(elems)
      })
    })(this, b, sqrtDelta, doubleA));
    return new $c_Lcalculator_Var().init___F0(expr$1)
  }
});
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, b$1, c$1, a$1) {
    return (function() {
      return (($uD(b$1.apply__O()) * $uD(b$1.apply__O())) - ((4 * $uD(c$1.apply__O())) * $uD(a$1.apply__O())))
    })
  })(this, b, c, a));
  return new $c_Lcalculator_Var().init___F0(expr)
});
